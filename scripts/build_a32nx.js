...
const A32NX = path.resolve(__dirname, '..', 'fbw-a32nx/out/flybywire-aircraft-a320-neo');
...
function copyDDSFiles(src_dds) {
    ...
    fs.copyFileSync(path.join(path.resolve(__dirname, '..', 'fbw-a32nx/src'), src_dds), path.join(A32NX, TARGET_PATH));
}
